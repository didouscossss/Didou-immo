...
class CityRef {
  ...
  final String codeDepartement;
  /// Code INSEE de la commune elle-même (ex. "86194" pour Poitiers) — sans
  /// lui, une requête VALORIS ne peut cibler que le département entier
  /// (`dept=` seul), qui mélange les communes rurales moins chères avec la
  /// ville-centre et fausse le chiffre à la baisse. Vide pour [nationalAvg].
  final String codeInsee;
  const CityRef(this.name, this.prixM2, this.loyerM2, this.tension, this.lat, this.lon,
      [this.codeDepartement = '', this.codeInsee = '']);
}
...
const List<CityRef> frenchCities = [
  CityRef('Paris', 9500, 32, true, 48.8566, 2.3522, '75', '75056'),
  CityRef('Lyon', 5200, 16, true, 45.7640, 4.8357, '69', '69123'),
  CityRef('Marseille', 3400, 14, true, 43.2965, 5.3698, '13', '13055'),
  CityRef('Toulouse', 3600, 13.5, true, 43.6047, 1.4442, '31', '31555'),
  CityRef('Nice', 5300, 18, true, 43.7102, 7.2620, '06', '06088'),
  CityRef('Nantes', 3700, 13, true, 47.2184, -1.5536, '44', '44109'),
  CityRef('Strasbourg', 3300, 12.5, true, 48.5734, 7.7521, '67', '67482'),
  CityRef('Montpellier', 3600, 14, true, 43.6108, 3.8767, '34', '34172'),
  CityRef('Bordeaux', 4600, 15, true, 44.8378, -0.5792, '33', '33063'),
  CityRef('Lille', 3200, 13, true, 50.6292, 3.0573, '59', '59350'),
  CityRef('Rennes', 3500, 13, true, 48.1173, -1.6778, '35', '35238'),
  CityRef('Reims', 2400, 11, false, 49.2583, 4.0317, '51', '51454'),
  CityRef('Le Havre', 2100, 10, false, 49.4944, 0.1079, '76', '76351'),
  CityRef('Saint-Étienne', 1300, 8.5, false, 45.4397, 4.3872, '42', '42218'),
  CityRef('Toulon', 3300, 14, false, 43.1242, 5.9280, '83', '83137'),
  CityRef('Angers', 2900, 11.5, false, 47.4784, -0.5632, '49', '49007'),
  CityRef('Dijon', 2700, 11, false, 47.3220, 5.0415, '21', '21231'),
  CityRef('Limoges', 1600, 9, false, 45.8336, 1.2611, '87', '87085'),
  CityRef('Clermont-Ferrand', 2100, 10.5, false, 45.7772, 3.0870, '63', '63113'),
  CityRef('Le Mans', 1900, 9.5, false, 48.0061, 0.1996, '72', '72181'),
  CityRef('Bourg-en-Bresse', 2300, 10.5, false, 46.2058, 5.2255, '01', '01053'),
  CityRef('Laon', 1500, 8.5, false, 49.5642, 3.6203, '02', '02408'),
  CityRef('Moulins', 1400, 8, false, 46.5654, 3.3327, '03', '03190'),
  CityRef('Digne-les-Bains', 2100, 10, false, 44.0917, 6.2358, '04', '04070'),
  CityRef('Gap', 2400, 10.5, false, 44.5594, 6.0790, '05', '05061'),
  CityRef('Privas', 1700, 9, false, 44.7350, 4.5985, '07', '07186'),
  CityRef('Charleville-Mézières', 1400, 8, false, 49.7738, 4.7196, '08', '08105'),
  CityRef('Foix', 1600, 8.5, false, 42.9647, 1.6053, '09', '09122'),
  CityRef('Troyes', 1900, 9.5, false, 48.2973, 4.0744, '10', '10387'),
  CityRef('Carcassonne', 1900, 9.5, false, 43.2130, 2.3491, '11', '11069'),
  CityRef('Rodez', 1700, 8.5, false, 44.3506, 2.5744, '12', '12202'),
  CityRef('Caen', 2900, 12, true, 49.1829, -0.3707, '14', '14118'),
  CityRef('Aurillac', 1400, 8, false, 44.9245, 2.4433, '15', '15014'),
  CityRef('Angoulême', 1700, 9, false, 45.6484, 0.1560, '16', '16015'),
  CityRef('La Rochelle', 4600, 15, true, 46.1603, -1.1511, '17', '17300'),
  CityRef('Bourges', 1500, 8.5, false, 47.0810, 2.3988, '18', '18033'),
  CityRef('Tulle', 1300, 8, false, 45.2671, 1.7716, '19', '19272'),
  CityRef('Ajaccio', 3800, 14, true, 41.9192, 8.7386, '2A', '2A004'),
  CityRef('Bastia', 3200, 13, true, 42.7028, 9.4508, '2B', '2B033'),
  CityRef('Saint-Brieuc', 2100, 9.5, false, 48.5136, -2.7652, '22', '22278'),
  CityRef('Guéret', 1000, 7, false, 46.1667, 1.8667, '23', '23096'),
  CityRef('Périgueux', 1700, 9, false, 45.1847, 0.7214, '24', '24322'),
  CityRef('Besançon', 2400, 11, false, 47.2378, 6.0241, '25', '25056'),
  CityRef('Valence', 2200, 10.5, false, 44.9334, 4.8924, '26', '26362'),
  CityRef('Évreux', 1900, 10, false, 49.0270, 1.1510, '27', '27229'),
  CityRef('Chartres', 2300, 11, false, 48.4439, 1.4890, '28', '28085'),
  CityRef('Quimper', 2600, 10.5, false, 47.9960, -4.0972, '29', '29232'),
  CityRef('Nîmes', 2600, 12, true, 43.8367, 4.3601, '30', '30189'),
  CityRef('Auch', 1600, 8.5, false, 43.6459, 0.5860, '32', '32013'),
  CityRef('Châteauroux', 1200, 7.5, false, 46.8098, 1.6960, '36', '36044'),
  CityRef('Tours', 3000, 12, true, 47.3941, 0.6848, '37', '37261'),
  CityRef('Grenoble', 3100, 13.5, true, 45.1885, 5.7245, '38', '38185'),
  CityRef('Lons-le-Saunier', 1800, 9, false, 46.6742, 5.5522, '39', '39300'),
  CityRef('Mont-de-Marsan', 2000, 9.5, false, 43.8898, -0.4989, '40', '40192'),
  CityRef('Blois', 2000, 9.5, false, 47.5861, 1.3359, '41', '41018'),
  CityRef('Le Puy-en-Velay', 1500, 8, false, 45.0430, 3.8850, '43', '43157'),
  CityRef('Orléans', 2700, 11.5, true, 47.9029, 1.9093, '45', '45234'),
  CityRef('Cahors', 1700, 8.5, false, 44.4477, 1.4372, '46', '46042'),
  CityRef('Agen', 1700, 9, false, 44.2049, 0.6212, '47', '47001'),
  CityRef('Mende', 1500, 8, false, 44.5178, 3.5000, '48', '48095'),
  CityRef('Saint-Lô', 1700, 9, false, 49.1147, -1.0899, '50', '50502'),
  CityRef('Châlons-en-Champagne', 1700, 9, false, 48.9560, 4.3630, '51', '51108'),
  CityRef('Chaumont', 1300, 7.5, false, 48.1113, 5.1391, '52', '52121'),
  CityRef('Laval', 1900, 9.5, false, 48.0698, -0.7700, '53', '53130'),
  CityRef('Nancy', 2600, 11.5, true, 48.6921, 6.1844, '54', '54395'),
  CityRef('Bar-le-Duc', 1200, 7.5, false, 48.7714, 5.1608, '55', '55029'),
  CityRef('Vannes', 3600, 12.5, true, 47.6582, -2.7603, '56', '56260'),
  CityRef('Metz', 2300, 11, false, 49.1193, 6.1757, '57', '57463'),
  CityRef('Nevers', 1300, 8, false, 46.9896, 3.1590, '58', '58194'),
  CityRef('Beauvais', 2000, 10, false, 49.4295, 2.0807, '60', '60057'),
  CityRef('Alençon', 1500, 8, false, 48.4322, 0.0900, '61', '61001'),
  CityRef('Arras', 2300, 10.5, false, 50.2910, 2.7807, '62', '62041'),
  CityRef('Pau', 2600, 11, false, 43.2951, -0.3708, '64', '64445'),
  CityRef('Tarbes', 1700, 8.5, false, 43.2327, 0.0781, '65', '65440'),
  CityRef('Perpignan', 2400, 11.5, true, 42.6986, 2.8954, '66', '66136'),
  CityRef('Colmar', 3200, 12, true, 48.0794, 7.3585, '68', '68066'),
  CityRef('Vesoul', 1400, 8, false, 47.6167, 6.1546, '70', '70550'),
  CityRef('Mâcon', 2200, 10.5, false, 46.3067, 4.8283, '71', '71270'),
  CityRef('Chambéry', 3400, 13.5, true, 45.5646, 5.9178, '73', '73065'),
  CityRef('Annecy', 5300, 17, true, 45.8992, 6.1294, '74', '74010'),
  CityRef('Rouen', 2700, 11.5, true, 49.4431, 1.0993, '76', '76540'),
  CityRef('Melun', 3200, 13.5, true, 48.5389, 2.6600, '77', '77288'),
  CityRef('Versailles', 6500, 22, true, 48.8049, 2.1204, '78', '78646'),
  CityRef('Niort', 2100, 10, false, 46.3239, -0.4587, '79', '79191'),
  CityRef('Amiens', 2400, 11, false, 49.8941, 2.2958, '80', '80021'),
  CityRef('Albi', 1900, 9.5, false, 43.9298, 2.1480, '81', '81004'),
  CityRef('Montauban', 2100, 10, false, 44.0175, 1.3547, '82', '82121'),
  CityRef('Avignon', 2900, 12.5, true, 43.9493, 4.8055, '84', '84007'),
  CityRef('La Roche-sur-Yon', 2100, 10, false, 46.6705, -1.4266, '85', '85191'),
  CityRef('Poitiers', 2400, 11, false, 46.5802, 0.3404, '86', '86194'),
  CityRef('Épinal', 1500, 8, false, 48.1735, 6.4457, '88', '88160'),
  CityRef('Auxerre', 1800, 9, false, 47.7982, 3.5730, '89', '89024'),
  CityRef('Belfort', 1900, 9.5, false, 47.6379, 6.8630, '90', '90010'),
  CityRef('Évry-Courcouronnes', 3500, 15, true, 48.6303, 2.4406, '91', '91228'),
  CityRef('Nanterre', 6500, 24, true, 48.8924, 2.2065, '92', '92050'),
  CityRef('Bobigny', 4000, 17, true, 48.9092, 2.4394, '93', '93008'),
  CityRef('Créteil', 4500, 18, true, 48.7904, 2.4556, '94', '94028'),
  CityRef('Cergy', 3600, 15, true, 49.0364, 2.0770, '95', '95127'),
];
